...
<style>
    ...
    .status-for-delivery { background-color: #cfe2ff; color: #084298; }
                ...
                <table class="table table-bordered card-table table-vcenter text-nowrap datatable">
                    ...
                    @foreach ($orders as $order)
                        <tr>
                            ...
                            <td class="text-center">
                                <!-- Action Buttons (For Delivery → Completed) -->
                                <button class="btn btn-danger btn-sm" onclick="updateStatus({{ $order->id }}, 'Cancelled')">Cancel</button>
                                <button class="btn btn-success btn-sm" onclick="updateStatus({{ $order->id }}, 'Completed')">Completed</button>
                                ...
                                <a href="{{ route('order.downloadInvoice', $order) }}" class="btn btn-icon btn-primary ms-1">
