    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="page-title mb-1">Edit Supplier</h2>
        ...
        <div class="col-lg-8">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('suppliers.update', $supplier) }}" method="POST" enctype="multipart/form-data" id="supplierForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-4">
                            <div class="col-md-4 text-center mb-4">
                                <div class="mb-3">
                                    <div class="mx-auto mb-3 d-flex align-items-center justify-content-center" style="width: 120px; height: 120px;" id="photoPreview">
                                        @if($supplier->photo)
                                            <img src="{{ Storage::url($supplier->photo) }}" alt="{{ $supplier->name }}" class="rounded-circle" style="width: 120px; height: 120px; object-fit: cover;">
                                        @else
