                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-2">
                                    <div class="progress" style="height: 10px;">
                                        <div class="progress-bar bg-primary" id="attendanceProgress" style="width: 100%"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card performance-metric-card h-100">
                            <div class="card-body">
                                ...
                                <div class="mt-2">
                                    <div class="progress" style="height: 10px;">
                                        <div class="progress-bar bg-info" id="taskProgress" style="width: 100%"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="d-flex flex-column flex-md-row align-items-center justify-content-between">
                                    <div class="mb-3 mb-md-0 text-center">
                                        ...
                                        <div class="display-4 fw-bold text-primary">
                                            <span id="calculatedScore">100.0</span>%
                                        </div>
                                    </div>
                                    <div class="text-center mb-3 mb-md-0">
                                        <h5 class="alert-heading mb-1">Performance Grade</h5>
                                        <span id="performanceGrade" class="badge bg-success fs-5">Excellent</span>
                                    </div>
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea name="remarks" class="form-control @error('remarks') is-invalid @enderror" 
                                rows="4" placeholder="Add any additional comments or observations about this performance evaluation...">{{ old('remarks') }}</textarea>
                            @error('remarks')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
